...
namespace WebGoat.NET.Migrations
{
    ...
    [Migration("20251124142816_AddedBlogResponseContent")]
    partial class AddedBlogResponseContent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebGoatCore.Models.BlogResponseContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("BlogResponseContents");
                });
            ...
            modelBuilder.Entity("WebGoatCore.Models.BlogResponseContent", b =>
                {
                    b.HasOne("WebGoatCore.Models.BlogResponse", "BlogResponse")
                        .WithOne("BlogResponseContent")
                        .HasForeignKey("WebGoatCore.Models.BlogResponseContent", "BlogResponseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BlogResponse");
                });
            ...
            modelBuilder.Entity("WebGoatCore.Models.BlogResponse", b =>
                {
                    b.Navigation("BlogResponseContent");
                });
